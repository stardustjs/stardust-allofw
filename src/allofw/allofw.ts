...
//         this._program = AllofwUtils.compileShaders({
//             vertex: generator.getCode(),
...
//             }
//         });
//         data.buffers.set(this._flattenedVertexIndexVariable, new GL3.Buffer());
//         data.vertexCount = 0;
...
//                     GL3.FALSE, 0, type.size * (shift.offset - minOffset) * this._flattenedVertexCount
//                 );
//             } else {
...
//                     GL3.vertexAttribPointer(attributeLocation,
//                         1, GL3.FLOAT, GL3.FALSE, 0, 4 * (-minOffset) * this._flattenedVertexCount
//                     );
//                 } else {
//                     let type = bindings.get(name).type;
//                     GL3.vertexAttribPointer(attributeLocation,
//                         type.primitiveCount, type.primitive == "float" ? GL3.FLOAT : GL3.INT,
//                         GL3.FALSE, 0, type.size * (-minOffset) * this._flattenedVertexCount
//                     );
//                 }
//             }
//         }
...
//     }
//     public uploadData(data: any[]): PlatformMarkData {
...
//             array[i] = i % rep;
//         }
//         GL3.bindBuffer(GL3.ARRAY_BUFFER, buffers.buffers.get(this._flattenedVertexIndexVariable));
//         GL3.bufferData(GL3.ARRAY_BUFFER, array.byteLength, array, GL3.STATIC_DRAW);
...
//     // Render the graphics.
//     public renderBase(buffers: AllofwPlatformMarkData): void {
...
//             // Draw arrays
//             GL3.drawArrays(GL3.TRIANGLES, 0, buffers.vertexCount - (this._maxOffset - this._minOffset) * this._flattenedVertexCount);
//             AllofwUtils.checkGLErrors("After draw arrays");
//             GL3.bindVertexArray(0);
//         }
//     }

//     public render(buffers: PlatformMarkData) {
//         this.renderBase(buffers as AllofwPlatformMarkData);
//     }
// }
