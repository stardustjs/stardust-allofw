...
export { AllofwPlatform3D as AllofwPlatform3DGS } from "./allofw/allofw";

import { registerPlatformConstructor } from "stardust-core";
import { AllofwPlatform3D } from "./allofw/allofw";
import { AllofwPlatform3D as AllofwPlatform3DGS } from "./allofw/allofwGS";
...
registerPlatformConstructor("allofw-3d-gs", (w: any, omni: any) => {
    return new AllofwPlatform3DGS(w, omni);
});